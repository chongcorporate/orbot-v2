...
//
// IMPORTANT: The Cancellation edge function now requires a shared-secret header
// (X-Orbot-Key) on every request. Before this script will work again, set the
// ORBOT_API_KEY script property once: in the Apps Script editor, go to Project
// Settings > Script Properties and add a property named ORBOT_API_KEY whose value
// matches the ORBOT_API_KEY secret configured on the Supabase Edge Function
